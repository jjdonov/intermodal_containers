defmodule IntermodalContainers.Size.Height do
  ...
  @all [
    ...
    %RangeCode{  code_character: "6", lower: %Bound{mm_limit: 2895, inches_limit: 9 * 12 + 6, inclusive: false}},
    %RangeCode{  code_character: "F", lower: %Bound{mm_limit: 2895, inches_limit: 9 * 12 + 6, inclusive: false}},
    %RangeCode{  code_character: "P", lower: %Bound{mm_limit: 2895, inches_limit: 9 * 12 + 6, inclusive: false}},
